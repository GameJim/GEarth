...
void MainWindow::createMenuFile()
{
    ...
    if (QAction* actionFile = ribbonBar()->addSystemButton(iconLogo, tr("&File"))) 
    {
        ...
        {
            QAction* newFile = popupBar->addAction(::qtnIcon(Image_New), tr("&New"));
            newFile->setShortcut(tr("Ctrl+N"));
            newFile->setStatusTip(tr("Create a new document"));
            newFile->setToolTip(tr("New"));
            newFile->setEnabled(false);

            QAction* openFile = popupBar->addAction(::qtnIcon(Image_Open, true), tr("&Open..."));
            openFile->setShortcut(tr("Ctrl+O"));
            openFile->setToolTip(tr("Open"));
            openFile->setStatusTip(tr("Open an existing document"));
            connect(openFile, SIGNAL(triggered()), this, SLOT(open()));

            QAction* saveFile = popupBar->addAction(::qtnIcon(Image_Save, true), tr("&Save"));
            ...
            QAction* actClose = popupBar->addAction(::qtnIcon(Image_Close), tr("&Close"));
...
void MainWindow::createQuickAccessBar()
{
    if (RibbonQuickAccessBar* quickAccessBar = ribbonBar()->quickAccessBar())
    {
        ...
        QAction* smallButton = quickAccessBar->addAction(::qtnIcon(Image_New), tr("New"));
        ...
        smallButton = quickAccessBar->addAction(::qtnIcon(Image_Open), tr("Open"));
        smallButton->setToolTip(tr("Open an existing document"));
        connect(smallButton, SIGNAL(triggered()), this, SLOT(pressButton()));
        quickAccessBar->setActionVisible(smallButton, false);

        smallButton = quickAccessBar->addAction(::qtnIcon(Image_Save), tr("Save"));
        smallButton->setToolTip(tr("Save the active document"));
        connect(smallButton, SIGNAL(triggered()), this, SLOT(pressButton()));

        smallButton = quickAccessBar->addAction(::qtnIcon(Image_Undo), tr("&Undo"));
        smallButton->setShortcut(QKeySequence::Undo);
        smallButton->setEnabled(false);

        smallButton = quickAccessBar->addAction(::qtnIcon(Image_Redo), tr("&Redo"));
...
void MainWindow::createRibbonBar()
{
    ...
    if (RibbonPage* pageButtons = ribbonBar()->addPage(tr("&Buttons")))
    {
        ...
        if ( RibbonGroup* groupClipboard = pageButtons->addGroup(tr("&Large Buttons")) ) 
        {
            ...
            action = groupClipboard->addAction(QIcon(":/res/Edit.Create.svg"), tr("Button &SVG"), Qt::ToolButtonTextUnderIcon);
            ...
            action = groupClipboard->addAction(QIcon(":/res/largeToggleButton.png"), tr("Toggle Button"), Qt::ToolButtonTextUnderIcon);
        ...
        if (RibbonGroup* groupGroups = pageButtons->addGroup(tr("Groups"))) 
        {
            ...
            QAction* smallButton = toolBarControl->addAction(::qtnIcon(Image_New), 
                tr("New"), Qt::ToolButtonIconOnly);
            smallButton->setToolTip(tr("Create a new document"));
            connect(smallButton, SIGNAL(triggered()), this, SLOT(pressButton()));

            smallButton = toolBarControl->addAction(::qtnIcon(Image_Open), 
                tr("Open"), Qt::ToolButtonIconOnly);
            smallButton->setToolTip(tr("Open an existing document"));
            connect(smallButton, SIGNAL(triggered()), this, SLOT(pressButton()));

            smallButton = toolBarControl->addAction(::qtnIcon(Image_Save), 
                tr("Save"), Qt::ToolButtonIconOnly);
            smallButton->setToolTip(tr("Save the active document"));
            connect(smallButton, SIGNAL(triggered()), this, SLOT(pressButton()));

            smallButton = toolBarControl->addAction(::qtnIcon(Image_Cut), 
                tr("Cut"), Qt::ToolButtonIconOnly);
            smallButton->setToolTip(tr("Cut the selection and put it on the Clipboard"));
            smallButton->setEnabled(false);
            connect(smallButton, SIGNAL(triggered()), this, SLOT(pressButton()));

            smallButton = toolBarControl->addAction(QIcon(":/res/smallCopy.png"), 
                tr("Copy"), Qt::ToolButtonIconOnly);
            smallButton->setToolTip(tr("Copy the selection and put it on the Clipboard"));
            smallButton->setEnabled(false);
            connect(smallButton, SIGNAL(triggered()), this, SLOT(pressButton()));

            smallButton = toolBarControl->addAction(::qtnIcon(Image_Clipboard), 
            ...
            smallButton = toolBarControl->addAction(::qtnIcon(Image_Undo), 
                tr("Undo"), Qt::ToolButtonIconOnly);
            smallButton->setToolTip(tr("Undo the last action"));
            smallButton->setEnabled(false);
            connect(smallButton, SIGNAL(triggered()), this, SLOT(pressButton()));

            smallButton = toolBarControl->addAction(::qtnIcon(Image_Redo), 
            ...
            smallButton = toolBarControl->addAction(QIcon(":/res/smallPrint.png"), 
                tr("Print"), Qt::ToolButtonIconOnly);
            smallButton->setToolTip(tr("Print the active document"));
            connect(smallButton, SIGNAL(triggered()), this, SLOT(pressButton()));

            smallButton = toolBarControl->addAction(QIcon(":/shared/res/about.png"), 
