...
{
    if(Qtitan::RibbonGroup* fontGroup = page->addGroup(tr("Font"))) 
    {
...
//        fontGroup->setContentAlignment(Qt::AlignVCenter);
        ...
        QAction* pCharStrikethrough = toolBar->addAction(QIcon(":/res/smallstrikethrough.png"), tr("Strikethrough"), Qt::ToolButtonIconOnly);
        pCharStrikethrough->setEnabled(false);
        toolBar->addSeparator();
        QAction* pTextSubscript = toolBar->addAction(QIcon(":/res/smallsubscript.png"), tr("Subscript"), Qt::ToolButtonIconOnly);
        pTextSubscript->setEnabled(false);
        QAction* pTextSuperscript = toolBar->addAction(QIcon(":/res/smallsuperscript.png"), tr("Superscript"), Qt::ToolButtonIconOnly);
        pTextSuperscript->setEnabled(false);
        QAction* pTextChangecase = toolBar->addAction(QIcon(":/res/smallchangecase.png"), tr("Change Case"), Qt::ToolButtonIconOnly);
        pTextChangecase->setEnabled(false);

        toolBar->addSeparator();

        Qtitan::PopupColorButton* highlightColorButton = new Qtitan::PopupColorButton();
        QAction* textHighlightcolor = toolBar->addWidget(QIcon(":/res/smallcolor.png"), tr("Highlight Color"), highlightColorButton);
        highlightColorButton->setDefaultAction(textHighlightcolor);
        textHighlightcolor->setEnabled(false);

        pColorButton = new Qtitan::PopupColorButton();
...
{
    Qtitan::RibbonGroup * paragraphGroup = page->addGroup(tr("&Paragraph"));
    if (paragraphGroup)
    {
 ...
 //       groupParagraph->setControlsGrouping();
        ...
        toolBar->addAction(QIcon(":/res/smallmultilevellist.png"), tr("Multilevel List"), Qt::ToolButtonIconOnly, pMenu);
        toolBar->addSeparator();
