    ...
    : QDialog(parent)
{
    ...
    m_itemsEffects = RibbonGalleryGroup::createGalleryGroup();
    ...
    m_galleryEffects = new RibbonGallery(this);
...
{
    if (RibbonPage* pageGallery = ribbonBar()->addPage( tr("&Galleries 1")))
    {
        if (RibbonGroup* groupPopup = pageGallery->addGroup(tr("Popup Galleries")))
        {
        ...
        if (RibbonGroup* groupInline = pageGallery->addGroup(tr("Inline Galleries")))
        {
    ...
    if (RibbonPage* pageGallery = ribbonBar()->addPage( tr("G&alleries 2")))
    {
        if (RibbonGroup* groupPopup = pageGallery->addGroup(tr("Shapes 1")))
        {
            // gallery shapes
            RibbonGalleryControl* galleryControl = new RibbonGalleryControl();
        ...
        if (RibbonGroup* groupPopup = pageGallery->addGroup(tr("Shapes 2")))
        {
          // gallery effects
          RibbonGalleryControl* galleryControl = new RibbonGalleryControl();
...
{
    m_itemsFontTextColor = RibbonGalleryGroup::createGalleryGroup();
    ...
    //-----------------------------------------------------------
    m_itemsTable = RibbonGalleryGroup::createGalleryGroup();
    ...
    m_itemsUndo = RibbonGalleryGroup::createGalleryGroup();
    ...
    m_itemsShapes = RibbonGalleryGroup::createGalleryGroup();
    ...
    m_itemsThemes = RibbonGalleryGroup::createGalleryGroup();
