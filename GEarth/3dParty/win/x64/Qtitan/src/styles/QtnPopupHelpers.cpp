...
void PopupOffice2003DrawHelper::refreshPalette()
{
    ...
    switch (m_styleType)
    {
        ...
        case OS_SYSTEMDARK:
            ...
            break;
        case OS_SYSTEMDARKGRAY:
            {
                m_palBackground.setColor(QPalette::Light, QColor(106, 106, 106));
                m_palBackground.setColor(QPalette::Dark, QColor(106, 106, 106));

                m_palGripper.setColor(QPalette::Light, QColor(106, 106, 106));
                m_palGripper.setColor(QPalette::Dark, QColor(106, 106, 106));

                m_palFrame.setColor(QPalette::Light, QColor(43, 87, 154));
                m_palFrame.setColor(QPalette::Dark, QColor(43, 87, 154));
        ...
        case OS_SYSTEMBLACK:
            {
                m_palBackground.setColor(QPalette::Light, QColor(37, 37, 37));
                m_palBackground.setColor(QPalette::Dark, QColor(37, 37, 37));

                m_palGripper.setColor(QPalette::Light, QColor(37, 37, 37));
                m_palGripper.setColor(QPalette::Dark, QColor(37, 37, 37));
...
void PopupOffice2007DrawHelper::refreshPalette()
{
    if (m_styleType == OS_SYSTEMBLUE)
    {
        ...
        m_palBackground.setColor(QPalette::Dark, m_helper->getColor("PopupControl", "BackgroundDark"));
        m_palBackground.setColor(QPalette::Light, m_helper->getColor("PopupControl", "BackgroundLight"));

        m_palGripper.setColor(QPalette::Dark, m_helper->getColor("PopupControl", "CaptionDark"));
        m_palGripper.setColor(QPalette::Light, m_helper->getColor("PopupControl", "CaptionLight"));

        m_palFrame.setColor(QPalette::Dark, m_helper->getColor("PopupControl", "FrameBorder"));
        m_palFrame.setColor(QPalette::Light, m_helper->getColor("PopupControl", "FrameBorder"));

        m_clrButtonSelected = m_helper->getColor("PopupControl", "ButtonSelected");
        m_clrButtonPressed = m_helper->getColor("PopupControl", "ButtonPressed");
        m_clrButtonSelectedBorder = m_helper->getColor("PopupControl", "ButtonBorder");
        m_clrButtonPressedBorder = m_helper->getColor("PopupControl", "ButtonBorder");
    }
    else
