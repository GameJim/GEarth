...
public:
    ...
    virtual QPixmap standardPixmap(StandardPixmap standardPixmap, const QStyleOption* opt, const QWidget* widget = Q_NULL) const;
    virtual QIcon standardIcon(StandardPixmap standardIcon, const QStyleOption* opt = Q_NULL, const QWidget* widget = Q_NULL) const;

protected:
    bool canWordWrap(const QRect& rect, const QFontMetrics& fm, const QString& str, int* heightLine = Q_NULL) const;
protected:
    /*! \internal */
    virtual QIcon modifyIcon(QStyle::StandardPixmap, const QStyleOption*, const QWidget*, bool& ret ) const { ret = false; return QIcon(); }
    ...
    /*! \internal */
    virtual bool drawFrameTabBarBase(const QStyleOption*, QPainter*, const QWidget*) const { return false; }
    /*! \internal */
    ...
    // for ComboBox
    virtual bool drawComboBoxLabel(ControlElement, const QStyleOption*, QPainter*, const QWidget*) const { return false; }
