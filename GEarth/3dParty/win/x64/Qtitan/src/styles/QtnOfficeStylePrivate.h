...
public:
    ...
    // for TabBar
    virtual bool drawFrameTabWidget(const QStyleOption*, QPainter*, const QWidget*) const = 0;
    virtual bool drawFrameTabBarBase(const QStyleOption*, QPainter*, const QWidget*) const = 0;
...
Q_DECLARE_INTERFACE(Qtitan::OfficePaintManagerInterface, "devmachines.Qtitan.OfficePaintManagerInterface")
...
public:
    ...
    QColor    m_clrTabNormalText; // Tab文字默认颜色
    QColor    m_clrTabHighlightText; // Tab文字高亮颜色
    QColor    m_clrHighlightText;
    QColor    m_clrTabSelectedText; // Tab文字选中颜色
...
class OfficePaintManager : public CommonPaintManager,
                           public OfficePaintManagerInterface
{
    Q_OBJECT
    Q_INTERFACES(Qtitan::OfficePaintManagerInterface)
public:
                               ...
                               public OfficePaintManagerInterface
{
    ...
    Q_INTERFACES(Qtitan::OfficePaintManagerInterface)
public:
    explicit OfficePaintManager2013(CommonStyle* baseStyle);
...
class OfficePaintManager2016 : public OfficePaintManager2013
{
    Q_OBJECT
    Q_INTERFACES(Qtitan::OfficePaintManagerInterface)
public:
    explicit OfficePaintManager2016(CommonStyle* baseStyle);
    virtual ~OfficePaintManager2016();
public:
    // shared
    virtual bool drawPanelTipLabel(const QStyleOption*, QPainter*, const QWidget*) const;
    // for editors
...
public:
    ...
    virtual QColor menuLabelColor() const;
private:
    Q_DISABLE_COPY(OfficePaintManager2016)
};
