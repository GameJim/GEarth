...
void CircleTool::activate()
{
    ...
    m_holder->addWidget(QIcon(), tr(" R:"), m_pRadius);
...
{
    m_holder->remove(m_pLabel1);
    delete m_pLabel1;
    m_pLabel1 = Q_NULL;

    m_holder->remove(m_pEditX1);
    delete m_pEditX1;
    m_pEditX1 = Q_NULL;

    m_holder->remove(m_pEditY1);
    delete m_pEditY1;
    m_pEditY1 = Q_NULL;

    m_holder->remove(m_pLabel2);
    delete m_pLabel2;
    m_pLabel2 = Q_NULL;

    m_holder->remove(m_pRadius);
    delete m_pRadius;
    m_pRadius = Q_NULL;
}
