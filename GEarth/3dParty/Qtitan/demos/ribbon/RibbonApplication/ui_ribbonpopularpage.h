...
public:
    ...
    {
        customizePopularPage->setWindowTitle(QApplication::translate("pageCustomizePopular", "Popular", Q_NULLPTR));
#ifndef QT_NO_STATUSTIP
        customizePopularPage->setStatusTip(QApplication::translate("pageCustomizePopular", "Change the most popular options", Q_NULLPTR));
#endif // QT_NO_STATUSTIP
        labelTitle->setText(QApplication::translate("pageCustomizePopular", "<html><head/><body><p><span style=\" font-weight:600;\">Top options for Working with Demo</span></p></body></html>", Q_NULLPTR));
        labelTheme->setText(QApplication::translate("pageCustomizePopular", "&Theme:", Q_NULLPTR));
        labelAccentColor->setText(QApplication::translate("pageCustomizePopular", "Accen&t Color (Office 2013 only):", Q_NULLPTR));
        pushButtonAccentColor->setText(QString());
        labelBackgroundImage->setText(QApplication::translate("pageCustomizePopular", "&Background Image (Office 2013 only):", Q_NULLPTR));
    } // retranslateUi
