This file contains information that will help you start using QtitanRibbon component
in your project. Please refer to this guide prior to using it.

This folder contains the installed version of QtitanRibbon component for Qt.C++. 

- Version

This folder contains QtitanRibbon (version 4.17.1).
The version was built with Qt5.10.1 - 32bit(for Windows), 64bit(for MacOSX, Linux)
...
To add QtitanRibbon component support to QtDesigner, copy the qtnribbondsgn.dll (libqtnribbondsgn.so) file to 
