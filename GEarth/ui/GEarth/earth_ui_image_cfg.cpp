#include "GEarth/earth_ui_image_cfg.h"
...
namespace ui
{
	...
	EarthUIImageCfg::EarthUIImageCfg()
	{
		libconfig::Config cfg;
		try
		{
			cfg.readFile("../ui_image.cfg");
		}
	...
	std::string EarthUIImageCfg::getImagePath() const
	{
		return "";
	}

	void EarthUIImageCfg::save(const std::string& sPath /*= ""*/)
	{
